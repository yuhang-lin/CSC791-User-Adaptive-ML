...
if individual_training:
    exportCSV(accuracies_2, "accuracy_cnn_indiv.csv")
    exportCSV(f1_scores_2, "f1_cnn_indiv.csv")
else:
    exportCSV(accuracies_2, "accuracy_cnn_agg.csv")
    exportCSV(f1_scores_2, "f1_cnn_agg.csv")
